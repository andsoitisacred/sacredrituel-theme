    ...
    try {
      ...
      const updatePrices = () => {
        ...
        skio.availableSellingPlanGroupIds.forEach(availableSellingPlanGroupId => {	
          ...
          $sellingPlanGroup.checked ? skio.isSubscription = true : skio.isSubscription = false
          if ($externalSubscriptionPrice && skio.isSubscription) {
            $externalSubscriptionPrice.innerHTML = price
          }
        })	
        // One-time	
        ...
        if ($externalOnetimePrice && !skio.isSubscription) $externalOnetimePrice.innerHTML = onetimePriceFormatted;
      }
